...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM account  WHERE Symbol_No = '$symbolNo' AND Last_Name = '$lastName'";
    ...
    if ($result->num_rows > 0) {
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["paymentFile"]["tmp_name"], $targetFile)) {
                ...
                $sql_update = "UPDATE account SET payment_slip = '$file_name' WHERE Symbol_No = '$symbolNo' AND Last_Name = '$lastName'";
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="payment_account.php" enctype="multipart/form-data">
