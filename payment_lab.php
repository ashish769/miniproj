...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM lab  WHERE Symbol_No = '$symbolNo' AND Last_Name = '$lastName'";
    ...
    if ($result->num_rows > 0) {
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["paymentFile"]["tmp_name"], $targetFile)) {
                ...
                $sql_update = "UPDATE lab SET payment_slip = '$file_name' WHERE Symbol_No = '$symbolNo' AND Last_Name = '$lastName'";
...
<body>
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">Payment Form for lab</div>
                    <div class="card-body">
                        <form method="POST" action="payment_lab.php" enctype="multipart/form-data">
