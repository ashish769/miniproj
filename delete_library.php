...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["confirmDelete"])) {
    ...
    $sql = "DELETE FROM library WHERE Symbol_No='$symbolNo'";

    if ($conn->query($sql) === TRUE) {
        header("Location: crud_library.php"); // Redirect to the CRUD page after successful deletion
        exit();
    } else {
    ...
    header("Location: crud_library.php"); // Redirect to the CRUD page if Symbol No is not provided
    exit();
}
?>
...
<body>
    <div class="container mt-5">
        ...
        <form method="POST" action="delete_library.php">
            ...
            <a href="crud_library.php" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
